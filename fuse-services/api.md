...
The Wao Studio REST API for accessing the data and the services of the Wao network in a simple way. You can use this API to query and interact with the objects of the Wao network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Wao network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Wao\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Wao network |
...
| homeBridgeAddress | `String` | Bridge address on the Wao network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Wao network |
...
Community is a set of contracts and services. Members of the community are users of the Wao network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Wao network |
| homeTokenAddress | `String` | Address of the community token on the Wao network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Wao network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Wao network |
...
Entity is an account on the Wao network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Wao network |
