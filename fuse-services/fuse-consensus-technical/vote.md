...
Wao chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://explorer.waoscan.com/address/0x4c889f137232E827c00710752E86840805A70484) with the following params:
...
Some other useful functions on the [voting contract](https://explorer.waoscan.com/address/0x4c889f137232E827c00710752E86840805A70484) are:
