...
[Any entity that is holding the Wao token can run a node](broken-reference) that approves transaction in the network and in doing so receive rewards in the form of Wao token (WAO).
...
[You can delegate you Wao token to a validator](broken-reference) of your choosing. Not everybody that wants to earn rewards need to be a validator! Any token holder can delegate their Wao token to a validator to earn rewards through the validator.
