...
We will learn how to connect Ledger to Metamask and use it on Wao network after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change to “Wao network” and perform the transactions on Wao network through your Ledger device.

Note: To learn how to add Wao network RPC follow [this link.](https://docs.waoscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
