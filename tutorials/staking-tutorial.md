---
description: This tutorial will explain how to delegate/stake/unstake your WAO.
---

# Staking tutorial

Note: You can only stake WAO which is on Wao network. Please make sure you have changed into Wao network in Metamask while doing any transactions on staking UI. 

How to Stake Wao:

**Step 1:**

Navigate to staking.waoscan.com and login to your wallet through metamask. Make sure you are on Wao network. If you are not please follow the instructions [**here**](https://docs.waoscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of WAO you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
